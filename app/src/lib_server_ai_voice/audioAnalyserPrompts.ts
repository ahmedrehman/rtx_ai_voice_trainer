...
export function createAudioAnalyserDefaultPrompts(options: AudioAnalyserPromptOptions = {}): AudioAnalyserPromptDefaults {
  ...
  return {
    systemPrompt: [
      "You are AUDIO_ANALYSER, the real server-side business method for the voice trainer.",
    ...
    task: [
      ...
      "Judge pronunciation and accent from the original audio, not from transcript text alone.",

...
export function VOICE_AGENT_V2_CREATE_PROMPTS(settings: VoiceAgentV2Settings): VoiceAgentPromptConfig {
  ...
  return {
    ...
    howToRespond: [
      ...
      "A foreign accent is OK when the sentence is understandable. Do not correct acceptable learner pronunciation.",
      "If grammar, vocabulary, and meaning are correct, set has_corrections false even when pronunciation is imperfect but understandable.",
      "Use correction_type pronunciation/accent only for a concrete sound issue that makes the word unclear, and only at correction level 1.",
      "Pronunciation or accent must never be level 2 or level 3. Never mark pronunciation or accent as a serious mistake.",
      "Before using level 3, verify there is an actual grammar error or severe meaning error in the words, not just pronunciation.",

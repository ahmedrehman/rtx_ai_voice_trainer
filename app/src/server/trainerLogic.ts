...
export function buildSystemPrompt(settings: AppSettings) {
  return [
    ...
    '  "shouldRespond": true,',
    '  "trigger": "keyword",',
    '  "notes": ["short correction reason"],',
    '  "visualFeedback": "improvement",',
    ...
    '- visualFeedback: one of "none", "improvement", "error"',
    ...
    "- Use visualFeedback improvement for small correction, error for serious grammar issue, none if no correction."
  ].join("\n");
}
